...
static void activate(GtkApplication *app, gpointer user_data) {
    ...
    gtk_window_set_title(GTK_WINDOW(window), "show_content_directory");
...
int main(int argc, char **argv) {
    GtkApplication *app = gtk_application_new("org.example.show_content_directory", G_APPLICATION_FLAGS_NONE);
